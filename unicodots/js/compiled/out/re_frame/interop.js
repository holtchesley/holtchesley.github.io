...
return [cljs.core.str((function (){var pred__42900 = cljs.core.instance_QMARK_;
var expr__42901 = reactive_val;
if(cljs.core.truth_(pred__42900.call(null,reagent.ratom.RAtom,expr__42901))){
return "ra";
} else {
if(cljs.core.truth_(pred__42900.call(null,reagent.ratom.RCursor,expr__42901))){
return "rc";
} else {
if(cljs.core.truth_(pred__42900.call(null,reagent.ratom.Reaction,expr__42901))){
return "rx";
} else {
if(cljs.core.truth_(pred__42900.call(null,reagent.ratom.Track,expr__42901))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1502937004625