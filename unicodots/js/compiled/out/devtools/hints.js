...
var map__56314 = top_item;
var map__56314__$1 = ((((!((map__56314 == null)))?((((map__56314.cljs$lang$protocol_mask$partition0$ & (64))) || (map__56314.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56314):map__56314);
var file = cljs.core.get.call(null,map__56314__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__56314__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__56314__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e56313){var _e = e56313;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___56316 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___56316)){
var seen_errors_56317 = temp__4655__auto___56316;
if(cljs.core.truth_(seen_errors_56317.has(self))){
} else {
seen_errors_56317.add(self);

var temp__4657__auto___56318 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___56318)){
var sense_56319 = temp__4657__auto___56318;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_56319)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1502937024334