...
var len__42146__auto___55554 = arguments.length;
var i__42147__auto___55555 = (0);
while(true){
if((i__42147__auto___55555 < len__42146__auto___55554)){
args__42153__auto__.push((arguments[i__42147__auto___55555]));

var G__55556 = (i__42147__auto___55555 + (1));
i__42147__auto___55555 = G__55556;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__42154__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq55552){
var G__55553 = cljs.core.first.call(null,seq55552);
var seq55552__$1 = cljs.core.next.call(null,seq55552);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__55553,seq55552__$1);
});
...
return (p1__55557_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1502937022956