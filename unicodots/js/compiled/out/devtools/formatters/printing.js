...
var len__42146__auto___55563 = arguments.length;
var i__42147__auto___55564 = (0);
while(true){
if((i__42147__auto___55564 < len__42146__auto___55563)){
args__42153__auto__.push((arguments[i__42147__auto___55564]));

var G__55565 = (i__42147__auto___55564 + (1));
i__42147__auto___55564 = G__55565;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__42154__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq55560){
var G__55561 = cljs.core.first.call(null,seq55560);
var seq55560__$1 = cljs.core.next.call(null,seq55560);
var G__55562 = cljs.core.first.call(null,seq55560__$1);
var seq55560__$2 = cljs.core.next.call(null,seq55560__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__55561,G__55562,seq55560__$2);
});
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__41677__auto__,writer__41678__auto__,opt__41679__auto__){
return cljs.core._write.call(null,writer__41678__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__55566_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__55566_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__55575__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e55579){var e__53117__auto__ = e55579;
return false;
}})();
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
...
}catch (e55581){var e__53117__auto__ = e55581;
return false;
}}
})())){
...
var _STAR_current_state_STAR_55586 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__55587 = opts;
var map__55587__$1 = ((((!((map__55587 == null)))?((((map__55587.cljs$lang$protocol_mask$partition0$ & (64))) || (map__55587.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55587):map__55587);
var markup_db = cljs.core.get.call(null,map__55587__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_55586;
}});
...
;
var temp__4655__auto___55592 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___55592)){
var managed_print_level_55593 = temp__4655__auto___55592;
var _STAR_print_level_STAR_55591_55594 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_55593;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_55591_55594,managed_print_level_55593,temp__4655__auto___55592,writer,opts,job_fn){
return (function (p1__55589_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__55589_SHARP_,null);
});})(_STAR_print_level_STAR_55591_55594,managed_print_level_55593,temp__4655__auto___55592,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_55591_55594;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1502937023070