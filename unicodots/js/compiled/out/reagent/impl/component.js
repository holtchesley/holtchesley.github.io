...
if((i < len)){
var k = (ks[i]);
var G__42637 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__42638 = (i + (1));
m = G__42637;
i = G__42638;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__42642 = c;
var G__42642__$1 = (((G__42642 == null))?null:G__42642.prototype);
if((G__42642__$1 == null)){
return null;
} else {
return (G__42642__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__42646 = c;
var G__42646__$1 = (((G__42646 == null))?null:G__42646.prototype);
if((G__42646__$1 == null)){
return null;
} else {
return (G__42646__$1["render"]);
}
})()));
});
...
while (G__42651__i < G__42651__a.length) {G__42651__a[G__42651__i] = arguments[G__42651__i + 0]; ++G__42651__i;}
  args = new cljs.core.IndexedSeq(G__42651__a,0);
} 
...
var _STAR_current_component_STAR_42655 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_42655;
}});
...
var G__42659 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__42659) {
...
var or__41071__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__42661_42663 = (c["cljsRatom"]);
if((G__42661_42663 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__42661_42663);
}
...
if(cljs.core.truth_((function (){var and__41059__auto__ = wrap;
...
if(((1) === cljs.core.count.call(null,renders_42666))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_42667)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_42667))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__41071__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
} else {
...
var render_fun__$1 = (function (){var or__41071__auto__ = render_fun;
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__41071__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
} else {
...
var name__$1 = (function (){var G__42665 = name;
switch (G__42665) {
case "":
...
var G__42670 = o;
(G__42670[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__42676 = (function (){var or__41071__auto__ = (function (){var G__42678 = c;
if((G__42678 == null)){
return null;
} else {
return (G__42678["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
...
return (G__42676["_currentElement"]);
}
})();
var name = (function (){var G__42679 = elem;
var G__42679__$1 = (((G__42679 == null))?null:(G__42679["type"]));
if((G__42679__$1 == null)){
return null;
} else {
return (G__42679__$1["displayName"]);
}
})();
var path = (function (){var G__42680 = elem;
var G__42680__$1 = (((G__42680 == null))?null:(G__42680["_owner"]));
var G__42680__$2 = (((G__42680__$1 == null))?null:reagent$impl$component$component_path.call(null,G__42680__$1));
if((G__42680__$2 == null)){
return null;
} else {
return [cljs.core.str(G__42680__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__41071__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
} else {
var G__42682 = c;
var G__42682__$1 = (((G__42682 == null))?null:G__42682.constructor);
if((G__42682__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__42682__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1502937004090