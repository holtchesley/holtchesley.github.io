...
goog.addDependency("../unicodots/dot.js", ['unicodots.dot'], ['cljs.core', 're_frame.loggers', 'cljs.core.match']);
...
goog.addDependency("../unicodots/views.js", ['unicodots.views'], ['unicodots.dot', 'cljs.core', 'goog.events.EventType', 're_frame.loggers', 'clojure.string', 'cljs.core.match', 'goog.events', 're_frame.core']);
goog.addDependency("../unicodots/db.js", ['unicodots.db'], ['unicodots.dot', 'cljs.core']);
goog.addDependency("../unicodots/events.js", ['unicodots.events'], ['unicodots.dot', 'cljs.core', 're_frame.loggers', 'unicodots.db', 'cljs.core.match', 're_frame.core']);
goog.addDependency("../unicodots/subs.js", ['unicodots.subs'], ['cljs.core', 're_frame.core']);
goog.addDependency("../unicodots/config.js", ['unicodots.config'], ['cljs.core']);
goog.addDependency("../unicodots/core.js", ['unicodots.core'], ['reagent.core', 'cljs.core', 'unicodots.views', 'unicodots.events', 'unicodots.subs', 'unicodots.config', 're_frame.core']);
...
goog.addDependency("../figwheel/connect/dev.js", ['figwheel.connect.dev'], ['unicodots.core', 'cljs.core', 'figwheel.client', 'figwheel.client.utils']);
