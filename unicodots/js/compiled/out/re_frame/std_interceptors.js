...
var vec__43445_43448 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_43449 = cljs.core.nth.call(null,vec__43445_43448,(0),null);
var only_after_43450 = cljs.core.nth.call(null,vec__43445_43448,(1),null);
var db_changed_QMARK__43451 = (cljs.core.some_QMARK_.call(null,only_before_43449)) || (cljs.core.some_QMARK_.call(null,only_after_43450));
if(db_changed_QMARK__43451){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_43449);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_43450);
...
var map__43458 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__43458__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__43458__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__43466 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__43466__$1;
var event = cljs.core.get.call(null,map__43466__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__42146__auto___43469 = arguments.length;
var i__42147__auto___43470 = (0);
while(true){
if((i__42147__auto___43470 < len__42146__auto___43469)){
args__42153__auto__.push((arguments[i__42147__auto___43470]));

var G__43471 = (i__42147__auto___43470 + (1));
i__42147__auto___43470 = G__43471;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__42154__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq43468){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq43468));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__41071__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__42153__auto__ = [];
var len__42146__auto___43477 = arguments.length;
var i__42147__auto___43478 = (0);
while(true){
if((i__42147__auto___43478 < len__42146__auto___43477)){
args__42153__auto__.push((arguments[i__42147__auto___43478]));

var G__43479 = (i__42147__auto___43478 + (1));
i__42147__auto___43478 = G__43479;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__42154__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__43472_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__43473_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__43473_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq43474){
var G__43475 = cljs.core.first.call(null,seq43474);
var seq43474__$1 = cljs.core.next.call(null,seq43474);
var G__43476 = cljs.core.first.call(null,seq43474__$1);
var seq43474__$2 = cljs.core.next.call(null,seq43474__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__43475,G__43476,seq43474__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1502937006050