...
var o__53092__auto__ = (function (){var temp__4657__auto__ = goog.object.get(window,"cljs");
if(cljs.core.truth_(temp__4657__auto__)){
var o__53104__auto__ = temp__4657__auto__;
return goog.object.get(o__53104__auto__,"core");
} else {
return null;
}
})();
return goog.object.get(o__53092__auto__,"js_reserved_QMARK_").call(o__53092__auto__,x);
});
devtools.munging.get_fn_source_safely = (function devtools$munging$get_fn_source_safely(f){
try{var o__53092__auto__ = f;
return goog.object.get(o__53092__auto__,"toString").call(o__53092__auto__);
}catch (e55376){var _ = e55376;
return "";
}});
...
try{var o__53092__auto___55379 = t;
goog.object.get(o__53092__auto___55379,"cljs$lang$ctorPrWriter").call(o__53092__auto___55379,t,writer);
}catch (e55378){var __55380 = e55378;
}
...
var char_code = (function (){var o__53092__auto__ = (new String(char$));
return goog.object.get(o__53092__auto__,"charCodeAt").call(o__53092__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__53092__auto__ = String;
return goog.object.get(o__53092__auto__,"fromCharCode").call(o__53092__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__55382 = num_code;
switch (G__55382) {
case (1):
return (185);
...
var o__53092__auto__ = String;
return goog.object.get(o__53092__auto__,"fromCharCode").call(o__53092__auto__,superscript_code);
});
/**
...
}catch (e55388){var e__53117__auto__ = e55388;
return false;
}})())){
...
var vec__55389 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__55389,(0),null);
...
var or__41071__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4657__auto____$1 = goog.object.get(o__53105__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__53104__auto__ = temp__4657__auto____$1;
return goog.object.get(o__53104__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__42146__auto___55398 = arguments.length;
var i__42147__auto___55399 = (0);
while(true){
if((i__42147__auto___55399 < len__42146__auto___55398)){
args__42153__auto__.push((arguments[i__42147__auto___55399]));

var G__55400 = (i__42147__auto___55399 + (1));
i__42147__auto___55399 = G__55400;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__42154__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__55394){
var vec__55395 = p__55394;
var ns_detector = cljs.core.nth.call(null,vec__55395,(0),null);
...
var G__55401 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__55402 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__55401;
remaining_tokens = G__55402;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq55392){
var G__55393 = cljs.core.first.call(null,seq55392);
var seq55392__$1 = cljs.core.next.call(null,seq55392);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__55393,seq55392__$1);
});
...
break;
default:
var o__53092__auto__ = window;
return goog.object.get(o__53092__auto__,"parseInt").call(o__53092__auto__,arity,(10));
...
var vec__55410 = cljs.core.split_with.call(null,(function (p1__55406_SHARP_){
return cljs.core.not_EQ_.call(null,p1__55406_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__55410,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__55410,(1),null);
...
var vec__55416 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__55416,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__55416,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__55419 = cljs.core.rest.call(null,remaining_tokens);
var G__55420 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__55419;
name_tokens = G__55420;
continue;
} else {
...
var args55421 = [];
var len__42146__auto___55433 = arguments.length;
var i__42147__auto___55434 = (0);
while(true){
if((i__42147__auto___55434 < len__42146__auto___55433)){
args55421.push((arguments[i__42147__auto___55434]));

var G__55435 = (i__42147__auto___55434 + (1));
i__42147__auto___55434 = G__55435;
continue;
} else {
}
break;
...
var vec__55424 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__55424,(0),null);
var arity = cljs.core.nth.call(null,vec__55424,(1),null);
var vec__55427 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__55427,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__55427,(1),null);
var vec__55430 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__55430,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__55430,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__55430,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__55430,(3),null);
...
var args55437 = [];
var len__42146__auto___55443 = arguments.length;
var i__42147__auto___55444 = (0);
while(true){
if((i__42147__auto___55444 < len__42146__auto___55443)){
args55437.push((arguments[i__42147__auto___55444]));

var G__55445 = (i__42147__auto___55444 + (1));
i__42147__auto___55444 = G__55445;
continue;
} else {
}
break;
...
var vec__55440 = result;
var munged_ns = cljs.core.nth.call(null,vec__55440,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__55440,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__55440,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__55440,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__55440,(4),null);
var arity = cljs.core.nth.call(null,vec__55440,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__55453 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__55453,(0),null);
var args = cljs.core.nth.call(null,vec__55453,(1),null);
var vec__55456 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__55456,(0),null);
var name = cljs.core.nth.call(null,vec__55456,(1),null);
...
var G__55459 = (arity + (1));
var G__55460 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__55461){
var vec__55465 = p__55461;
var arity = cljs.core.nth.call(null,vec__55465,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__55465,(1),null);
...
return (function (p1__55468_SHARP_){
return cljs.core.get.call(null,arities,p1__55468_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__55469_SHARP_);
...
var args__42153__auto__ = [];
var len__42146__auto___55476 = arguments.length;
var i__42147__auto___55477 = (0);
while(true){
if((i__42147__auto___55477 < len__42146__auto___55476)){
args__42153__auto__.push((arguments[i__42147__auto___55477]));

var G__55478 = (i__42147__auto___55477 + (1));
i__42147__auto___55477 = G__55478;
continue;
} else {
}
break;
...
var argseq__42154__auto__ = ((((1) < args__42153__auto__.length))?(new cljs.core.IndexedSeq(args__42153__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__42154__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__55472){
var vec__55473 = p__55472;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__55473,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq55470){
var G__55471 = cljs.core.first.call(null,seq55470);
var seq55470__$1 = cljs.core.next.call(null,seq55470);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__55471,seq55470__$1);
});
...
var G__55480 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__55480) {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__41059__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__41071__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
} else {
...
var map__55487 = options;
var map__55487__$1 = ((((!((map__55487 == null)))?((((map__55487.cljs$lang$protocol_mask$partition0$ & (64))) || (map__55487.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55487):map__55487);
var include_ns_QMARK_ = cljs.core.get.call(null,map__55487__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__55487__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__55487__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__55487__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__55488 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__55488,(0),null);
var fn_name = cljs.core.nth.call(null,vec__55488,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__55488,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__55488,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__55488,(4),null);
var arity = cljs.core.nth.call(null,vec__55488,(5),null);
...
return [cljs.core.str((function (){var or__41071__auto__ = protocol_part;
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
} else {
return fn_part;
...
var o__53092__auto__ = f;
return goog.object.get(o__53092__auto__,"getBasis").call(o__53092__auto__);
});
/**
...
}catch (e55493){var e__53117__auto__ = e55493;
...
var G__55494 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__55495 = cljs.core.rest.call(null,path);
obj = G__55494;
path = G__55495;
continue;
} else {
...
var partition_bits = (function (){var or__41071__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
} else {
return (0);
...
return (function (accum,p__55500){
var vec__55501 = p__55500;
var bit = cljs.core.nth.call(null,vec__55501,(0),null);
var protocol = cljs.core.nth.call(null,vec__55501,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__55504){
var vec__55508 = p__55504;
var ns = cljs.core.nth.call(null,vec__55508,(0),null);
var name = cljs.core.nth.call(null,vec__55508,(1),null);
var selector = cljs.core.nth.call(null,vec__55508,(2),null);
...
return (function (p__55516){
var vec__55517 = p__55516;
var munged_name = cljs.core.nth.call(null,vec__55517,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__55517,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__55517,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__55511_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__55511_SHARP_));
});})(name,sorted_matches,vec__55517,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1502937022782